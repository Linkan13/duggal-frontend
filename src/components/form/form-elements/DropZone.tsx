...
const DropzoneComponent: React.FC<DropzoneProps> = ({ onDrop }) => {
  ...
  return (
    <ComponentCard title="Dropzone" className="p-2">
      <div
        {...getRootProps()}
        className={`transition border border-dashed cursor-pointer rounded-xl p-4
          ${isDragActive
      ...
      >
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <span className="text-brand-500 text-xs font-medium underline cursor-pointer">
            Browse File
          </span>
        </div>
      </div>
