            ...
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                <div className="avatar avatar-md br-10 icon-rotate bg-primary flex-shrink-0">
                  <span className="d-flex align-items-center">
                    <i className="ti ti-delta text-white fs-16"></i>
                  </span>
                </div>
                <div className="ms-3">
              ...
              <p className="fw-medium fs-13 mb-0">
                <span className="text-danger fs-12">
                  <i className="ti ti-arrow-wave-right-up me-1"></i>-4.01%{" "}
                </span>{" "}
                from last week
              </p>
            ...
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                <div className="avatar avatar-md br-10 icon-rotate bg-secondary flex-shrink-0">
                  <span className="d-flex align-items-center">
                    <i className="ti ti-currency text-white fs-16"></i>
                  </span>
                </div>
                <div className="ms-3">
                  <p className="fw-medium text-truncate mb-1">
            ...
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                <div className="avatar avatar-md br-10 icon-rotate bg-danger flex-shrink-0">
                  <span className="d-flex align-items-center">
                    <i className="ti ti-stairs-up text-white fs-16"></i>
                  </span>
                </div>
                <div className="ms-3">
                  <p className="fw-medium text-truncate mb-1">
              ...
              <p className="fw-medium fs-13 mb-0">
                <span className="text-success fs-12">
                  <i className="ti ti-arrow-wave-right-up me-1"></i>+55%{" "}
                </span>{" "}
                from last week
              </p>
              <span className="position-absolute top-0 end-0">
            ...
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                <div className="avatar avatar-md br-10 icon-rotate bg-purple flex-shrink-0">
                  <span className="d-flex align-items-center">
                    <i className="ti ti-users-group text-white fs-16"></i>
                  </span>
                </div>
                <div className="ms-3">
                  <p className="fw-medium text-truncate mb-1">
            ...
            <div className="card-body pb-0">
              <div className="row g-2 justify-content-center mb-3">
                ...
                <div className="col-md col-sm-4 col-6">
                  <div className="border rounded p-2">
                    <p className="mb-1">
                      <i className="ti ti-point-filled text-primary"></i>Not
                      Contacted
                    </p>
                    <h6>12566</h6>
                  </div>
                ...
                <div className="col-md col-sm-4 col-6">
                  <div className="border rounded p-2">
                    <p className="mb-1">
                      <i className="ti ti-point-filled text-primary"></i>Closed
                    </p>
                    <h6>8965</h6>
                  </div>
                </div>
                <div className="col-md col-sm-4 col-6">
                  <div className="border rounded p-2">
                    <p className="mb-1">
                      <i className="ti ti-point-filled text-primary"></i>Lost
                    </p>
                    <h6>2452</h6>
                  </div>
                </div>
                  ...
                  <div className="border border-dashed bg-transparent-light rounded p-2 mb-2">
                    <div className="d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        ...
                        >
                          <img
                            src="https://smarthr.co.in/demo/html/template/assets/img/company/company-24.svg"
                      ...
                      <span className="badge badge-purple d-inline-flex align-items-center">
                        <i className="ti ti-point-filled me-1"></i> Not
                        Contacted
                      </span>
                    </div>
                  </div>
                  <div className="border border-dashed bg-transparent-light rounded p-2 mb-2">
                    <div className="d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        ...
                        >
                          <img
                            src="https://smarthr.co.in/demo/html/template/assets/img/company/company-25.svg"
                            className="w-auto h-auto"
                            alt="Img"
                          />
                        </a>
                  ...
                  <div className="border border-dashed bg-transparent-light rounded p-2 mb-2">
                    <div className="d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        ...
                        >
                          <img
                            src="https://smarthr.co.in/demo/html/template/assets/img/company/company-26.svg"
                            className="w-auto h-auto"
                            alt="Img"
                          />
                        </a>
                  ...
                  <div className="border border-dashed bg-transparent-light rounded p-2 mb-2">
                    <div className="d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        ...
                        >
                          <img
                            src="https://smarthr.co.in/demo/html/template/assets/img/company/company-27.svg"
                            className="w-auto h-auto"
                            alt="Img"
                          />
                        </a>
                  ...
                  <div className="border border-dashed bg-transparent-light rounded p-2">
                    <div className="d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        ...
                        >
                          <img
                            src="https://smarthr.co.in/demo/html/template/assets/img/company/company-28.svg"
                            className="w-auto h-auto"
                            alt="Img"
                          />
                        </a>
            ...
            <div className="card-body">
              <div className="d-flex align-items-center justify-content-between mb-4">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://smarthr.co.in/demo/html/template/assets/img/users/user-27.jpg"
              ...
              <div className="d-flex align-items-center justify-content-between mb-4">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://smarthr.co.in/demo/html/template/assets/img/users/user-42.jpg"
                      className="rounded-circle border border-2"
                      alt="img"
                    />
                  </a>
                ...
                <div className="d-flex align-items-center">
                  <a href="#" className="btn btn-light btn-icon btn-sm">
                    <i className="ti ti-phone-x fs-16"></i>
                  </a>
                </div>
              </div>
              <div className="d-flex align-items-center justify-content-between mb-4">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://smarthr.co.in/demo/html/template/assets/img/users/user-43.jpg"
                      className="rounded-circle border border-2"
                      alt="img"
                    />
                  </a>
              ...
              <div className="d-flex align-items-center justify-content-between mb-4">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://smarthr.co.in/demo/html/template/assets/img/users/user-11.jpg"
                      className="rounded-circle border border-2"
                      alt="img"
                    />
                  </a>
              ...
              <div className="d-flex align-items-center justify-content-between">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://smarthr.co.in/demo/html/template/assets/img/users/user-45.jpg"
                      className="rounded-circle border border-2"
                      alt="img"
                    />
                  </a>
          ...
          <div className="card flex-fill">
            <div className="card-header">
              <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                ...
                <div>
                  <a
                    href="https://smarthr.co.in/demo/html/template/activity.html"
                ...
                <div className="flex-fill ps-3 timeline-flow">
                  <p className="fw-medium text-gray-9 mb-1">
                    ...
                    >
                      Meeting With{" "}
                      <img
                        src="https://smarthr.co.in/demo/html/template/assets/img/users/user-58.jpg"
          ...
          <div className="card flex-fill">
            ...
            <div className="card-body">
              ...
              <div className="d-flex align-items-start mb-4">
                <a href="javascript:void(0);" className="avatar flex-shrink-0">
                  <img
                    src="https://smarthr.co.in/demo/html/template/assets/img/users/user-28.jpg"
                    className="rounded-circle border border-2"
                    alt="img"
                  />
                </a>
              ...
              <div className="d-flex align-items-start mb-4">
                <a href="javascript:void(0);" className="avatar flex-shrink-0">
                  <img
                    src="https://smarthr.co.in/demo/html/template/assets/img/users/user-29.jpg"
                    className="rounded-circle border border-2"
                    alt="img"
                  />
                </a>
          ...
          <div className="card flex-fill">
            ...
            <div className="card-body">
              <div className="row align-items-center">
                <div className="col-xxl-5 col-sm-6">
                  <div className="pe-3 border-end">
                    <div className="d-flex align-items-center mb-4">
                      <span className="me-2">
                        <i className="ti ti-point-filled text-primary fs-16"></i>
                      </span>
                      <a
                        href="https://smarthr.co.in/demo/html/template/countries.html"
                        className="avatar rounded-circle flex-shrink-0 border border-2"
                      >
                        <img
                          src="https://smarthr.co.in/demo/html/template/assets/img/payment-gateway/country-03.svg"
                      ...
                      <div className="ms-2">
                        <h6 className="fw-medium text-truncate mb-1">
                          <a href="https://smarthr.co.in/demo/html/template/countries.html">
                            Singapore
                          </a>
                        </h6>
                    ...
                    <div className="d-flex align-items-center mb-4">
                      <span className="me-2">
                        <i className="ti ti-point-filled text-secondary fs-16"></i>
                      </span>
                      <a
                        href="https://smarthr.co.in/demo/html/template/countries.html"
                        className="avatar rounded-circle flex-shrink-0 border border-2"
                      >
                        <img
                          src="https://smarthr.co.in/demo/html/template/assets/img/payment-gateway/country-04.svg"
                          className="img-fluid rounded-circle"
                          alt="img"
                        />
                      </a>
                    ...
                    <div className="d-flex align-items-center mb-4">
                      <span className="me-2">
                        <i className="ti ti-point-filled text-info fs-16"></i>
                      </span>
                      <a
                        href="https://smarthr.co.in/demo/html/template/countries.html"
                        className="avatar rounded-circle flex-shrink-0 border border-2"
                      >
                        <img
                          src="https://smarthr.co.in/demo/html/template/assets/img/payment-gateway/country-05.svg"
                          className="img-fluid rounded-circle"
                          alt="img"
                        />
                      </a>
                    ...
                    <div className="d-flex align-items-center mb-4">
                      <span className="me-2">
                        <i className="ti ti-point-filled text-danger fs-16"></i>
                      </span>
                      <a
                        href="https://smarthr.co.in/demo/html/template/countries.html"
                        className="avatar rounded-circle flex-shrink-0 border border-2"
                      >
                        <img
                          src="https://smarthr.co.in/demo/html/template/assets/img/payment-gateway/country-01.svg"
                          className="img-fluid rounded-circle"
                          alt="img"
                        />
                      </a>
                    ...
                    <div className="d-flex align-items-center">
                      <span className="me-2">
                        <i className="ti ti-point-filled text-warning fs-16"></i>
                      </span>
                      <a
                        href="https://smarthr.co.in/demo/html/template/countries.html"
                        className="avatar rounded-circle flex-shrink-0 border border-2"
                      >
                        <img
                          src="https://smarthr.co.in/demo/html/template/assets/img/payment-gateway/country-02.svg"
                          className="img-fluid rounded-circle"
                          alt="img"
                        />
                      </a>
                ...
                <div className="col-xxl-7 col-sm-6"></div>
              </div>
            </div>
          </div>
            ...
            <div className="card flex-fill">
              <div className="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                ...
                <div className="d-flex align-items-center">
                  <div>
                    <a
                      href="https://smarthr.co.in/demo/html/template/leads.html"
                      className="btn btn-sm btn-light px-3"
                    >
                      View All
                    </a>
                      ...
                      <tr>
                        <td>
                          <h6 className="fw-medium">
                            <a href="https://smarthr.co.in/demo/html/template/leads-details.html">
                              Collins
                            </a>
                          </h6>
                        </td>
                        <td>
                          <div className="d-flex align-items-center file-name-icon">
                            <a
                              href="https://smarthr.co.in/demo/html/template/company-details.html"
                              className="avatar border rounded-circle"
                            >
                              <img
                                src="https://smarthr.co.in/demo/html/template/assets/img/company/company-01.svg"
                                className="img-fluid"
                                alt="img"
                              />
                            </a>
                            <div className="ms-2">
                              <h6 className="fw-medium">
                                <a href="https://smarthr.co.in/demo/html/template/company-details.html">
                      ...
                      <tr>
                        ...
                        <td>
                          <div className="d-flex align-items-center file-name-icon">
                            ...
                            >
                              <img
                                src="https://smarthr.co.in/demo/html/template/assets/img/company/company-04.svg"
                                className="img-fluid"
                                alt="img"
                              />
                            </a>
